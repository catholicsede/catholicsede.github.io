...
<span class="bible-note">Note : </span> Job 6, 5 : Un onagre, âne sauvage.
...
<span class="bible-note">Note : </span> Job 6, 7 : Mon âme, hébraïsme pour ma personne, moi.
...
<span class="bible-note">Note : </span> Job 6, 10 : Saint ; par excellence, Dieu.

11 Car quelle est ma force, pour que je tienne ferme? ou quelle est ma fin, pour que j'agisse patiemment?

<span class="bible-note">Note : </span> Job 6, 11 : Quelle est ma fin ? c’est-à-dire quelle sera la fin de ma vie, pour que je puisse conserver ma patience jusque-là ?
...
<span class="bible-note">Note : </span> Job 6, 16 : En me fuyant, mes amis croient éviter un mal ; mais, par une juste punition de leur inhumanité, ils tomberont dans un autre bien plus grand.
...
<span class="bible-note">Note : </span> Job 6, 18 : Sont cachés (comparer à Job, 3, 23) ; selon d’autres, détournés, tortueux.
