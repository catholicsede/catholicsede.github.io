...
<span class="bible-note">Note : </span> Bar. 5, 2 : Diploïde ; robe doublée de fourrure des anciens Orientaux.
...
<span class="bible-note">Note : </span> Bar. 5, 4 : Paix, etc. Ces noms conviennent mieux encore à l’Eglise de Jésus-Christ qu’à la Jérusalem terrestre, qui en était la figure.
...
<span class="bible-note">Note : </span> Bar. 5, 5 : Regarde vers l’Orient, etc. Voir Baruch, 4, 36-37.
...
<span class="bible-note">Note : </span> Bar. 5, 7 : Le Seigneur a résolu, etc. ; allusion à Isaïe, 40, 3-4.
