...
<span class="bible-note">Note : </span> Judith 11, 4 : Achèvera, etc. ; vous donnera un succès complet.
...
<span class="bible-note">Note : </span> Judith 11, 7 : Voir Judith, 5, 5.
...
<span class="bible-note">Note : </span> Judith 11, 10 : Le manque d’eau ; littéralement la sécheresse de l’eau ; ellipse pour, la sécheresse produite par le manque d’eau.
...
<span class="bible-note">Note : </span> Judith 11, 12 : Les choses saintes, etc. Les choses consacrées au Seigneur, telles que les prémices du blé, etc.
...
<span class="bible-note">Note : </span> Judith 11, 19 : Pour le sens des paroles ; c’est-à-dire pour la sagesse qu’il y a dans ses paroles.
