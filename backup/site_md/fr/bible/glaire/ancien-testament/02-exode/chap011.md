...
<span class="bible-note">Note : </span> Ex. 11, 2 : Voir Exode, 12, 35. ― Que chaque homme demande, etc. Voir Exode, 3, 22.
...
<span class="bible-note">Note : </span> Ex. 11, 3 : Voir Ecclésiastique, 45, 1.
...
<span class="bible-note">Note : </span> Ex. 11, 5 : Ayant un an (anniculus) ; où né dans l’année. Comparer à Lévitique, 22, 27.
...
<span class="bible-note">Note : </span> Ex. 11, 8 : Ceux-ci; c’est-à-dire les Israélites, synonyme d’Israël qui précède immédiatement.
...
<span class="bible-note">Note : </span> Ex. 11, 10 : Qui sont écrits, raconté ici dans ce livre, et qui font partie des événements arrivés en Egypte.
