...
<span class="bible-note">Note : </span> Dn. 3, 2-3 : Les princes (tyrannos). Voir Daniel, 1, 3. Les interprètes les plus habiles et les plus consciencieux conviennent que la signification rigoureuse de ces noms de dignités ne saurait être bien déterminée.
...
<span class="bible-note">Note : </span> Dn. 3, 4 : Peuples, tribus et langues ; c’est-à-dire peuples, tribus de différentes langues, ou de langue quelconque, comme on lit au verset 96. Ce genre de construction se trouve dans d’autres passages de la Bible ; c’est une figure grammaticale, nommée hendiade ; c’est-à-dire une chose exprimée par deux mots.
...
<span class="bible-note">Note : </span> Dn. 3, 21 : Enumération des diverses pièces qui composaient le costume chaldéen.
...
<span class="bible-note">Note : </span> Dn. 3, 38 : Il n’est pas parmi nous, etc. ; c’est-à-dire dans notre nation, dans la Judée, comme autrefois, des rois et des princes absolus, des prophètes avec autorité, un état réglé et indépendant. Dans la captivité, il y avait des chefs des tribus qui conservaient quelque autorité sur les autres captifs. Comparer à 4 Rois, 25, 27 ; 1 Paralipomènes, 5, 6 ; Daniel, chapitre 13.
...
<span class="bible-note">Note : </span> Dn. 3, 44 : Qui font souffrir ; littéralement qui montrent. Dans le style biblique on dit souvent voir, pour sentir, éprouver ; et faire voir, montrer, pour faire sentir, faire éprouver.
...
<span class="bible-note">Note : </span> Dn. 3, 46 : Du naphte ou bitume, matière très inflammable. Le naphte proprement dit est une huile minérale dans le genre du pétrole.
...
<span class="bible-note">Note : </span> Dn. 3, 53 : Le temple saint de votre gloire ; le ciel. Le temple de Jérusalem n’existait plus alors.

54 Vous êtes béni sur le trône de votre royaume, souverainement louable et souverainement exalté dans les siècles.

<span class="bible-note">Note : </span> Dn. 3, 54 : Le trône de votre royaume ; c’est-à-dire le ciel.
...
<span class="bible-note">Note : </span> Dn. 3, 55 : Qui êtes assis sur des chérubins. Les chérubins de l’arche d’alliance.
...
<span class="bible-note">Note : </span> Dn. 3, 59 : Voir Psaumes, 148, 4.
...
<span class="bible-note">Note : </span> Dn. 3, 65 : Souffles ; c’est-à-dire, vents que Dieu fait souffler.
...
<span class="bible-note">Note : </span> Dn. 3, 67 : Chaleur brûlante. Ce mot, joint ici au froid, doit signifier l’espèce de brûlure que produit un froid trop vif sur les êtres animés.
...
<span class="bible-note">Note : </span> Dn. 3, 82 : Fils des hommes. Voir sur le sens de cette expression, Daniel, 2, 38.
...
<span class="bible-note">Note : </span> Dn. 3, 86 : Esprits, etc. ; les âmes des saints séparées de leurs corps.
...
<span class="bible-note">Note : </span> Dn. 3, 90 : Ce qui précède, etc. ; remarque de saint Jérôme. Voir le verset 23.
...
<span class="bible-note">Note : </span> Dn. 3, 92 : A un fils de Dieu ; à un ange.
...
<span class="bible-note">Note : </span> Dn. 3, 96 : Et langue quelconque. Voir Daniel, 3, 4.
...
<span class="bible-note">Note : </span> Dn. 3, 100 : Voir Daniel, 4, 31 ; 7, 14. ― Toutes les générations ; littéralement, génération et génération. Dans le style biblique, comme on l’a déjà vu, la répétition d’un même substantif indique souvent l’universalité.
